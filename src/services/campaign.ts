...
export default class CampaignService {
  ...
  public async GetCampaignByUserId( id: string): Promise<{ campaign: ICampaign[] }> {
    try {
       ...
       */
      this.logger.silly('campaign');
      this.logger.silly('get campaign db record');
      const campaignRecord = await this.campaignModel.find({userId: id});
      this.logger.silly('Generating JWT');
  ...
  public async GetCampaignsByDomain( domain: string): Promise<{ campaign: ICampaign[] }> {
   ...
   public async GetCampaignsByCountry( state: string): Promise<{ campaign: ICampaign[] }> {
    try {
     ...
     /* get a campaign with specific status*/
     ...
     public async GetCampaignsByNickName( name: string): Promise<{ campaign: ICampaign[] }> {
      try {
